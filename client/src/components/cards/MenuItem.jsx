import { HStack, Box, Card,CardHeader,CardBody, Flex, Heading, Image, useMediaQuery } from "@chakra-ui/react";
...
const MenuItem = ({ _id, name, image, ingredients, price, description}) => {
  ...
  return (
    <Card  bg="white" size="sm" maxWidth={isSmall ? "100%" :"250px"} minWidth={"200px"} borderRadius={"none"} boxShadow={"md"} borderStyle={"solid"} borderWidth={"1px"} borderColor={"gray.100"} >
      <CardHeader>
      ...
      <CardBody color="gray.400" fontSize="13px">
          ...
          <HStack>
              <AddFood editing={true} foodName={name} foodIngredients={ingredients} foodPrice={price} foodImages={image} foodId={_id} foodDescription={description} width={"70px"} />
